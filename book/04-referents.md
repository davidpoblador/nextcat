...
El Regne Unit va crear el Government Digital Service (GDS) el 2011 com a unitat transversal dins del Cabinet Office, amb un mandat clar: transformar els serveis digitals del govern britànic posant l'usuari al centre. El resultat va ser la substitució de **1.882 llocs web governamentals** per un sol domini, GOV.UK, en menys d'un any i a menys del 30% del cost anual previ. [Font: [Public Digital, GDS case study](https://public.digital/pd-insights/client-stories/gds)]
