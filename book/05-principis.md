...
El model d'Estònia és la referència: un únic e-ID vàlid per a tots els serveis, amb un registre d'auditoria que el ciutadà pot consultar per veure qui ha accedit a les seves dades i quan. La confiança en el sistema digital depèn de la capacitat de l'usuari de verificar que el sistema funciona com s'ha promès.
