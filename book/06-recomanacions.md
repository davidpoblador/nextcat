...
### Inversió en l'ecosistema AINA

Finançar el desenvolupament de tercers sobre els models Salamandra: extensions per a entorns de desenvolupament, kits de desenvolupament per a integradors i interfícies de programació accessibles per a pimes i administracions locals. Exigir suport natiu en català a tots els sistemes d'IA conversacional contractats per la Generalitat, amb indicadors de qualitat objectivables (no pas "disponible en català" sinó "qualitat equivalent a la versió castellana").
