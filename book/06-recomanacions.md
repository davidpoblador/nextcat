...
Un mecanisme de qualitat que val la pena incorporar des del primer dia és el que a les empreses de producte es coneix com a *dogfooding*: l'exigència que les persones que construeixen un servei siguin també les primeres a fer-lo servir per als seus tràmits reals abans de llançar-lo a la ciutadania. Si l'equip que dissenya el formulari d'autoliquidació ha de presentar la seva pròpia declaració amb aquell mateix formulari, els defectes es detecten abans i la motivació per resoldre'ls deixa de ser abstracta: és una molèstia personal. El GDS britànic aplica aquesta pràctica de manera sistemàtica als serveis de GOV.UK. És un mecanisme de cost pràcticament zero, i l'efecte sobre la qualitat percebuda difícilment es replica per cap altra via.
...
La xarxa hauria d'incloure, com a mínim, el BSC, el Projecte AINA, les universitats catalanes amb capacitat tècnica rellevant ([UPC](https://www.upc.edu/), [UAB](https://www.uab.cat/), [UB](https://www.ub.edu/), [URV](https://www.urv.cat/), [UdG](https://www.udg.edu/), [UOC](https://www.uoc.edu/)), les empreses del sector amb base a Catalunya i experts individuals amb trajectòria reconeguda. Hauria d'operar amb regles clares de transparència, gestió de conflictes d'interès i de propietat intel·lectual, i amb fites públiques i mesurables cada vuit o dotze setmanes.
...
La proposta concreta és construir una **Caixa d'Eines Digital Catalana**: un conjunt reduït de components de base, oberts, documentats i gestionats com a infraestructura pública comuna. Cadascun ha de ser de codi obert per defecte, reutilitzable per qualsevol administració catalana (Generalitat, consells comarcals, ajuntaments, entitats del sector públic), obert a les contribucions d'empreses i ciutadans, i oferir-se a més com a servei allotjat per la mateixa Generalitat perquè els ajuntaments petits i les entitats amb equip tècnic limitat no n'hagin d'assumir l'operació.

Els components prioritaris, tots inspirats en patrons que ja han demostrat l'enfocament en altres administracions, haurien de cobrir com a mínim:

- **Notificacions públiques** (correu electrònic i SMS), en la línia de [GOV.UK Notify](https://www.notifications.service.gov.uk/). Cada departament n'envia milers cada mes; no hi ha cap raó perquè cadascú en construeixi la seva.
...
- **Motor comú de formularis**, seguint la filosofia del [GOV.UK Form Builder](https://www.forms.service.gov.uk/): una base reutilitzable que uniformitza l'experiència de tots els tràmits i redueix el cost de disseny departament per departament.
- **Pagaments digitals**, en la línia de [GOV.UK Pay](https://www.payments.service.gov.uk/): cobrament de taxes, multes i tarifes sense haver de contractar una passarel·la comercial per a cada servei.
- **Interfícies de programació de dades obertes** (vegeu la recomanació següent), dissenyades seguint el patró de [data.gov.uk](https://data.gov.uk/) i l'arquitectura d'X-Road: exposició estable, documentada i versionada dels conjunts de dades públiques.
- **Notificació i intercanvi de documents amb validesa legal**, inspirat en la capa d'intercanvi documental d'Estònia, per substituir progressivament la correspondència per correu certificat per equivalents digitals amb la mateixa força jurídica.

L'argument econòmic clau és l'**efecte de xarxa**: com més administracions fan servir el mateix servei de notificacions o el mateix motor de formularis, més estable i capaç es torna i més barat surt per a tothom. La primera administració que adopta el component paga poc més del que pagaria per una solució pròpia; cadascuna de les següents el fa servir pràcticament gratis i, si hi contribueix, el millora per a les altres. És exactament l'oposat del model actual, en el qual cada subvenció municipal a la digitalització acaba pagant una versió lleugerament diferent de la mateixa peça.

L'equip de serveis digitals transversal proposat a les accions immediates és el candidat natural per liderar la Caixa d'Eines, amb la xarxa permanent d'experts validant decisions tècniques i amb una política de contractació explícita: qualsevol inversió pública que duplicaria un component ja existent a la Caixa haurà de justificar-ne la desviació, no a l'inrevés.
